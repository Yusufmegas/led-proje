...
with sync_playwright() as p:
    ...
    page.evaluate("document.querySelector('.site-header').style.position='absolute'")
    ...
    page.locator(".v6-quote").screenshot(path=str(OUT / "quote-form-390.png"))
    page.close()

    shots = [("/ic-mekan-led-ekran","indoor-1440.png"),("/dis-mekan-led-ekran","outdoor-1440.png"),("/led-ekran-teknik-servis","service-1440.png"),("/led-ekran-fiyatlari","pricing-1440.png"),("/istanbul-led-ekran","istanbul-1440.png"),("/sik-sorulan-sorular","faq-1440.png")]
    ...
    assert all(value > 0 for url,value in inbound.items() if url != "https://ledproje.com.tr")
    page.goto(BASE, wait_until="networkidle")
    ...
    page.locator('.v6-quote button[type="submit"]').click()
...
assert not issues, "\n".join(issues)
print("QA_OK routes=36 orphans=0 broken_links=0 console_issues=0 screenshots=11")
